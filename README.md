...
## Managed Data Services
  ...
  * [xata lite](https://lite.xata.io) - Xata is a serverless database with built-in powerful search and analytics. One API, multiple type-safe client libraries, and optimized for your development workflow. According to the [pricing page](https://lite.xata.io/pricing), the free tier includes 15GB of data storage. (According to the [docs](https://lite.xata.io/docs/concepts/pricing), Database storage in Xata encompasses not only disk space but also I/O rates and compute resources.)
